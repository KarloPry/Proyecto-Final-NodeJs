...
function displayEmployee(employee){
    ...
    for(var i = 0; i < employee.length; i++){
        ...
        <td><button style="margin-left:auto;margin-right:auto;"onclick="updateEmployee(${employee[i].idEmpleado})">Actualizar</button></td>`
    }
...
function updateEmployee(id) {
    ...
    window.location.href = 'employeeUpdateMenu.html'
}